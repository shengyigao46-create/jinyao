...
import { startChatSession, sendMessage, generateDiary } from './services/geminiService';
          ...
          {currentView === 'INFO' && (
             <div className="pointer-events-auto p-12 max-w-3xl text-center glass-panel rounded-xl shadow-2xl z-20">
               ...
               <p className="text-lg leading-relaxed text-gray-300 font-serif">
                 A digital sanctuary dedicated to the intersection of thought and atmospheric immersion. 
                 Engage in deep philosophical discourse under the shelter of a digital window, 
                 while the elements of nature reflect the turbulence and clarity of the mind.
               </p>
               <div className="mt-8 pt-8 border-t border-white/10 text-sm text-gray-500 font-mono">
                 Created with React, Three.js, and Gemini.
               </div>
             </div>
          )}
